...
namespace DataStructures.Graph.AdjancencySet
{
        ...
        where TW : IComparable
    {
        ...
        public IGraphVertex<T> _referenceVertex;
        public IEnumerable<IGraphVertex<T>> _verticesAsEnumerable;
        ...
        public void AddEdge(T source, T dest,TW weight)
        {
            ...
            if (vertices[source].OutEdges.ContainsKey(vertices[dest]) ||
                vertices[dest].InEdges.ContainsKey(vertices[source]))//symetric
            {
        ...
        /*
         Aşağıdaki yerine yukarıdakini yazdım hocadan farklı olarak, program.cs'te nedense getvertex çalışmıyordu.
        ...
        IDiGraphVertex<T> IDiGraph<T>.ReferenceVertex => vertices[this.First()];
        ...
        public IEnumerable<T> Edges(T key)
        {
            ...
            else
            {
                ...
                //return vertices[key].OutEdges.Select(x => x.Key.Key); böyle de olabilir.
            }
        }
